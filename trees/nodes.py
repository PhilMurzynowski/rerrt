...
class RRTNode:
    ...
    Note: Whereas RRT does not used linearized matrices at runtime (A, B, G) and TVLQR matrices (S, K),
    RERRT does in order to propogate ellipsoids.
    Typically used with RRT if neccessary after building tree.
